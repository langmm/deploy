...
def shared_data(package_path, filename=None, pattern=None,
    ...
    :Parameters:
        - `package_path` (str or list) - Can be either a string representing a package path or a list of package paths.
        (e.g. :py:class:`path`('/home/user/openalea/deploy/src/openalea/deploy') or
        [:py:class:`path`('/usr/lib/pymodules/python2.7/numpy')]).
